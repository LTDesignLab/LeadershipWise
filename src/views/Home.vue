<template>
  <div class="home">
    ...
    <div class="progress-circle-container div1">
      <CircleProgress
        class="circle-progress"
        title="Average Grade"
        :percentage="totalAverage" 
        progressColor="#3B5A89"
        ringColor="rgba(0,0,0,0.1)" 
        :strokeWidth="12"
      />  
    </div>
    <div class="data-container div3">
      <DataList 
        title="Students" 
        :test="false" 
        :expandable="true"
        :graphable="true"
        :data="students" 
        :columnTitles="['NAME','EMAIL','COMPANY','SKILL', 'CITY', 'AVERAGE']"
        :columnKeys="['name','email','company','skill', 'city', 'average']"
        @addToList="handleAdd()"
